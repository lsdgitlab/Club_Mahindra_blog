...
if ($('#bannerCarousel').length) {
  let bannerCarousel = $('#bannerCarousel').owlCarousel({
    ...
    navText: [
      "<i class='arrow-banner left'></i>",
      "<i class='arrow-banner right'></i>",
    ],
...
if ($('.accordionFaq').length) new Accordion('.accordionFaq')
;(function () {
  ...
  function setClickHandler(id, fn) {
    ...
    // console.log(id)
    // console.log(fn)
    if ($('#' + id).length) document.getElementById(id).onclick = fn
  }
})()
